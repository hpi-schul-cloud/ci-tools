...
GIT_CURRENT_VERSION_TAG ?= $(shell git tag --list "v[0-9]*" --sort="-version:refname" --points-at HEAD | head -n 1)
GIT_LATEST_VERSION_TAG ?= $(shell git tag --list "v[0-9]*" --sort="-version:refname" | head -n 1)
